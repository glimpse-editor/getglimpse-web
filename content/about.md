...
The 1.x releases will be based on the upstream GNU Image Manipulation Program v3.x. The aim of these releases will be to provide a well-documented, supportable base that benefits from the upstream ports to GTK3 and Meson.
