...
The free software we produce is called "Glimpse Image Editor", but we sometimes shorten that to just "Glimpse". We refer to our governance structure, core contributors and participants on our Matrix channel as "the Glimpse project". We often call our social media followers, third party packagers, donors and end users "the Glimpse Community".
