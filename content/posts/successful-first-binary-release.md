...
We believe we have gone above and beyond the level of transparency and scrutiny that most free software projects are normally willing to subject themselves to. We have chosen to do that to ensure the governance team can be held accountable by the Glimpse project, and to ensure the wider community can have confidence in our motives and intentions. If you have any concerns, then you are welcome to raise them with us on [our Matrix channel](https://matrix.to/#/#glimpse:matrix.org).
