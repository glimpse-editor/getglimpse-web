...
We estimate that Glimpse Image Editor has been downloaded at least 12441 times across all platforms and download sources since it was first released on 2019-11-22, and we are likely supporting an active install base of around 5000 machines.

If these figures are accurate then this would be a good early result for us, and are [almost double the numbers we reported](/posts/progress-on-our-first-errata-release/) on 2020-01-31. It is worth remembering that Glimpse Image Editor has only been available to download for a little over three months, we are working with very limited resources, and this project had quite a mixed response from the wider free software community when it was first started.
