...
If these figures are accurate then this would be a good early result for us. It is worth remembering that Glimpse Image Editor has only been available to download for a little over three months, we have had a mixed response to starting this project from the wider free software community, and we produce releases with surprisingly few resources.
